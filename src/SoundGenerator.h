...
#ifndef SOUNDGENERATOR_H_
#define SOUNDGENERATOR_H_
...
public:
	...
	SoundGenerator() : frequencies(16), fadeout(16) {
		output = 0;
		input = 0;
		active = true;
		amplification = -1;
	...
	virtual int16_t getSampleValue(note_t frequency, block_time_t sample_time) = 0;
